    ...
    <div class="slide-1 home-slider">
        ...
        <div>
            <div class="home text-center">
                <img src="{{ asset('storage/app/'. $slider->slider_image) }}" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                ...
                <div class="product-5 product-m no-arrow">
                        ...
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img
                                        src="{{asset('public')}}/frontend_asset/images/vegetables/pro/1.jpg"
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img
                                        src="{{asset('public')}}/frontend_asset/images/vegetables/pro/2.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart"
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img
                                        src="{{asset('public')}}/frontend_asset/images/vegetables/pro/3.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart"
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img
                                        src="{{asset('public')}}/frontend_asset/images/vegetables/pro/4.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart"
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img
                                        src="{{asset('public')}}/frontend_asset/images/vegetables/pro/5.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart"
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img
                                        src="{{asset('public')}}/frontend_asset/images/vegetables/pro/6.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart"
...
<section class="section-b-space pt-0">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="title4">
                    <h2 class="title-inner4">Product Category</h2>
                    <div class="line"><span></span></div>
                </div>
                <div class="slide-6 no-arrow">
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{asset('public')}}/frontend_asset/images/icon/cat1.png" alt=""></div>
                        </a>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{asset('public')}}/frontend_asset/images/icon/cat2.png" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>casual shoes</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{asset('public')}}/frontend_asset/images/icon/cat3.png" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>formal shoes</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{asset('public')}}/frontend_asset/images/icon/cat4.png" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>flat</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{asset('public')}}/frontend_asset/images/icon/cat5.png" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>heels</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{asset('public')}}/frontend_asset/images/icon/cat6.png" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>boots</h5>
...
<section class="p-0">
    <div class="full-banner parallax text-left p-left">
        <img src="{{asset('public')}}/frontend_asset/images/parallax/15.jpg" alt="" class="bg-img blur-up lazyload">
        <div class="container">
            <div class="row">
                <div class="col">
                            ...
                            <div class="sec-1">
                                <div class="product-box2">
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img
                                                ...
                                                src="{{asset('public')}}/frontend_asset/images/vegetables/pro/1.jpg" alt=""></a>
                                ...
                                <div class="product-box2">
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img
                                                class="img-fluid blur-up lazyload"
                                                src="{{asset('public')}}/frontend_asset/images/vegetables/pro/2.jpg" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                            ...
                            <div>
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img
                                                    src="{{asset('public')}}/frontend_asset/images/vegetables/pro/9.jpg"
                            ...
                            <div class="sec-1">
                                <div class="product-box2">
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img
                                                class="img-fluid blur-up lazyload"
                                                src="{{asset('public')}}/frontend_asset/images/vegetables/pro/7.jpg" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                ...
                                <div class="product-box2">
                                    <div class="media">
                                        <a href="product-page(no-sidebar).html"><img
                                                class="img-fluid blur-up lazyload"
                                                src="{{asset('public')}}/frontend_asset/images/vegetables/pro/5.jpg" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                    class="fa fa-star"></i> <i class="fa fa-star"></i></div>
        ...
        <div class="row partition3">
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-left">
                        <div class="img-part">
                            <img src="{{asset('public')}}/frontend_asset/images/pets/banner/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
            ...
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-right text-right">
                        <div class="img-part">
                            <img src="{{asset('public')}}/frontend_asset/images/pets/banner/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="contain-banner banner-3">
                            <div>
                                <h2>Groom</h2>
            ...
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-left">
                        <div class="img-part">
                            <img src="{{asset('public')}}/frontend_asset/images/pets/banner/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="contain-banner banner-3">
                            <div>
                                <h2>food</h2>
        ...
        <div class="row partition3 banner-top-cls">
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-right">
                        <div class="img-part">
                            <img src="{{asset('public')}}/frontend_asset/images/pets/banner/4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="contain-banner banner-3">
                            <div>
                                <h2>Home</h2>
            ...
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-right text-right">
                        <div class="img-part">
                            <img src="{{asset('public')}}/frontend_asset/images/pets/banner/5.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="contain-banner banner-3">
                            <div>
                                <h2>cats</h2>
            ...
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-right">
                        <div class="img-part">
                            <img src="{{asset('public')}}/frontend_asset/images/pets/banner/6.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="contain-banner banner-3">
                            <div>
                                <h2>bowls</h2>
